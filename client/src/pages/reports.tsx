...
export default function Reports() {
  ...
  let earliestShiftStart: Date | undefined = undefined;
  Object.values(oeeHistory).forEach(machine => {
  ...
  if (earliestShiftStart !== undefined) {
    const shiftStartTime = earliestShiftStart as Date;
    plannedProductionMinutes = Math.floor((estTime.getTime() - shiftStartTime.getTime()) / 60000);
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={320}>
                  <LineChart data={avgOEETrend} margin={{ top: 16, right: 32, left: 8, bottom: 8 }}>
                    ...
                    <Tooltip formatter={(v) => v != null && typeof v === 'number' ? `${v.toFixed(1)}%` : "--"} />
                    <Legend />
